...
/* package YAML-Formatter-0.1.0.0 */
#ifndef VERSION_YAML_Formatter
#define VERSION_YAML_Formatter "0.1.0.0"
#endif /* VERSION_YAML_Formatter */
#ifndef MIN_VERSION_YAML_Formatter
#define MIN_VERSION_YAML_Formatter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_YAML_Formatter */
...
#define CURRENT_COMPONENT_ID "YAML-Formatter-0.1.0.0-inplace-YAML-Formatter"
